...
if __name__ == "__main__":
    ...
    print("> dtm_voxel[index_dtm_bottom_voxel].shape={}, size={}".format(dtm_voxel[index_dtm_bottom_voxel].shape, dtm_voxel[index_dtm_bottom_voxel].size))
    # 3-3 voxelize tls
    ...
    #visualize_voxel_key_points(tls_voxel_key_points, tls_nb_points_per_voxel, "voxelized tls ", only_points=True)
    ...
    #visualize_voxel_key_points(dls_voxel_key_points, dls_nb_points_per_voxel, "voxelized dls ", only_points=True)
    exit()
    # 4. plot nb_voxel & coincidence_ratio
    ...
    '''
    #get_slice_data_bis(dtm_voxel[index_dtm_bottom_voxel], layer_bot, layer_top, voxel_size, tls_voxel_grid, dls_voxel_grid, slice_height, x_min_overlap, y_min_overlap)